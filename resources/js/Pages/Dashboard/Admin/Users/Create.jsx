                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-8 flex items-center justify-between">
                        <div>
                            ...
                            <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Tambah Pengguna Baru</h1>
                                ...
                                <div className="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
                                    ...
                                    <div className="sm:col-span-1">
                                        ...
                                        <p className="mt-1.5 text-xs text-slate-500">
                                            Role menentukan hak akses pengguna dalam aplikasi.
                                        </p>
                                    </div>

                                    {/* Divider */}
                                    <div className="sm:col-span-2 my-2 border-t border-slate-100 flex items-center gap-4">
                                        <span className="text-xs font-semibold text-slate-500 bg-white pr-2 uppercase tracking-wide">Keamanan</span>
                                    </div>
