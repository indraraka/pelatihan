...
export default function Register({ recaptchaSiteKey, googleEnabled }) {
                ...
                <div className="relative w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                        <Link href="/" className="inline-flex items-center gap-3">
                            ...
                            <span className="text-3xl font-bold text-white">Training Management</span>
                        </Link>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl p-8">
                        ...
                        <p className="text-slate-600 mb-8">Bergabung dan mulai perjalanan belajar Anda</p>
                        ...
                        {googleEnabled && (
                            <>
                                ...
                                <a
                                    href="/auth/google"
                                    className="w-full flex items-center justify-center gap-3 py-4 border-2 border-slate-200 rounded-xl font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all"
                                >
